...
function agregarPropiedad(objeto, propiedad) {
   ...
   // Retornar el objeto.
   // Tu código:
   objeto[propiedad] = null // debe ser bracket ya que 'propieadad' es una variable
   return objeto
}
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   // Retornar el objeto.
   // Tu código:
   objetoUsuario.amigos.push(nuevoAmigo) // de esta manera se editan los arrays dentro de los objetos›
   return objetoUsuario
}
